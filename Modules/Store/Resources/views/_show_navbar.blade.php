                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex flex-wrap fw-semibold fs-6 mt-4 pe-2">
                                <a href="#"
                                    class="d-flex align-items-center text-gray-400 text-hover-primary mb-2 pe-5">
                        ...
                        @if (!$store->is_accepted)
                            <div class="d-flex my-4">
                                <form method="post" action="{{route('dashboard.stores.accept',$store->id)}}">
                                    @csrf
                                    <a onclick="event.preventDefault(); this.closest('form').submit()" href="{{route('dashboard.stores.accept',$store->id)}}" class="btn btn-sm btn-light me-2" id="kt_user_follow_button">
                        ...
                        <div class="d-flex align-items-center w-200px w-sm-300px flex-column mt-3">
                            ...
                            <div class="h-5px mx-3 w-100 bg-light mb-3">
                                <div class="bg-success rounded h-5px" role="progressbar"
                                    style="width: {{$store->rating}}%;" aria-valuenow="50" aria-valuemin="0"
