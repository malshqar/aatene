@extends('dashboard::index', ['title' => 'اضافة مجموعة جديدة'])
@section('content')
    <!--begin::Main-->
    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
        ...
        <div class="d-flex flex-column flex-column-fluid">
            <!--begin::Toolbar-->
            @include('shared::layouts.components.elements.toolbar', ['back_url' => 'dashboard.groups.index', 'previews' => 'قائمة المجموعات', 'current' => 'اضافة مجموعة جديدة'])
            <!--end::Toolbar-->
            <!--begin::Content-->
                            ...
                            <div class="card-body">
                                ...
                                <form class="form" action="{{ route('dashboard.groups.store') }}" method="POST"
                                    ...
                                    <div class="fv-row mb-6 d-flex flex-center">
                                        ...
                                        <div class="w-75">
                                            @include('shared::layouts.forms.inputs.input-with-lable', ['name' => 'name', 'lable' => 'اسم المجموعة', 'placeholder' => 'أدخل اسم المجموعة'])
                                            <div class="mt-5">
