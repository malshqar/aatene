...
<form class="my-auto pb-5" novalidate="novalidate" id="kt_create_account_form">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <label
                            ...
                            <i class="ki-duotone ki-badge fs-3x me-5"><span class="path1"></span><span
                ...
                <div class="mb-0">
                        ...
                        <span class="d-flex align-items-center me-2">
                            ...
                            <span class="symbol symbol-50px me-6">
                                <span class="symbol-label">
                                    <i class="ki-duotone ki-bank fs-1 text-gray-600"><span class="path1"></span><span
                                            class="path2"></span></i>
                                </span>
                            </span>
                            <!--end::Icon-->
                    ...
                    <label class="d-flex flex-stack mb-5 cursor-pointer">
                        ...
                        <span class="d-flex align-items-center me-2">
                            ...
                            <span class="symbol symbol-50px me-6">
                                <span class="symbol-label">
                                    <i class="ki-duotone ki-chart fs-1 text-gray-600"><span class="path1"></span><span
                                            class="path2"></span></i>
                                </span>
                            </span>
                            <!--end::Icon-->
	...
	">
            ...
            <div class="fv-row mb-10">
                ...
                <!--begin::Input-->
                <select name="business_type" class="form-select form-select-lg form-select-solid" data-control="select2"
        ...
        <div class="w-100">
            ...
            <div class="pb-8 pb-lg-10">
                ...
                <div class="text-muted fw-semibold fs-6">
                    ...
                    <a href="/authentication/layouts/corporate/sign-in.html" class="link-primary fw-bold">
                        Sign In
                    </a>
                    .
                </div>
