        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                            ...
                            <div class="d-flex flex-wrap flex-sm-nowrap">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex my-4">
                                        @if(!is_null($seller->ban_at))
                                            <form method="post" action="{{route('dashboard.sellers.cancel-ban', $seller->id)}}">
                                                @csrf
                    ...
                    <!--end::Navbar-->
                    @if(is_null($seller->ban_at))
                        <form action="{{ route('dashboard.sellers.blocked', $seller->id) }}" method="post">
                            @csrf
                            <!--begin::details View-->
                            <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                                ...
                                <div class="card-header cursor-pointer">
                                    ...
                                    <div class="card-title m-0">
                                        <h3 class="fw-bold m-0">حظر البائع</h3>
                                    </div>
                                    <!--end::Card title-->
                                </div>
                                <!--begin::Card header-->
                                ...
                                <div class="card-body p-9">
                                    ...
                                    <div class="row mb-10">
                                        <div class="col-lg-8">
                                            @include('shared::layouts.forms.inputs.input-with-lable', ['name' => 'ban_reason', 'lable' => 'سبب الحظر ', 'placeholder' => 'أدخل سبب حظر  البائع'])
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    <!--end::Row-->
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-lg-8">
                                            <label for="" class="form-label required">حدد مدة حظر {{ $seller->name }}</label>
