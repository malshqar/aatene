@extends('dashboard::index', ['title' => 'البائعين'])
...
@section('content')
    ...
    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
        ...
        <div class="d-flex flex-column flex-column-fluid">
            <!--begin::Toolbar-->
            @include('shared::layouts.components.elements.toolbar', ['back_url' => 'dashboard.index', 'previews' => 'الرئيسية', 'current' => 'قائمة البائعين'])
            <!--end::Toolbar-->
            <!--begin::Content-->
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table text-center align-middle gs-0 gy-4">
                                    ...
                                    <tbody>
                                                ...
                                                <td>
                                                    <div class="d-flex text-start align-items-center">
                                                        ...
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <a href="{{ route('dashboard.sellers.show', $seller->id) }}"
                                                                class="text-dark fw-bold text-hover-primary mb-1 fs-6">{{ $seller->name }}
                                                            </a>
                                                            <span
                                                                class="text-muted fw-semibold text-muted d-block fs-7">{{ $seller->email }}</span>
                                                        </div>
                                                    </div>
                                                </td>

                                                <td>
                                                    <span class="badge badge-light-success fs-7 fw-bold px-5">
                                                        {{ $seller->gold_coins}}
                                                    </span>
                                                </td>
                                                <td>
                                        ...
                                        @endforeach
                                        <tr>
                                            <td colspan="8"> {{ $sellers->WithQueryString()->links() }}</td>
                                        </tr>
                                    </tbody>
                                    <!--end::Table body-->
                                </table>
