@extends('dashboard::index', ['title' => "تعديل بيانات $seller->name"])
@section('content')
    <!--begin::Main-->
    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
        ...
        <div class="d-flex flex-column flex-column-fluid">
            <!--begin::Toolbar-->
            @include('shared::layouts.components.elements.toolbar', ['back_url' => 'dashboard.sellers.index', 'previews' => 'قائمة البائعين', 'current' => "تعديل بيانات $seller->name"])
            <!--end::Toolbar-->
            <!--begin::Content-->
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <form class="form d-flex flex-column flex-lg-row"
                        action="{{ route('dashboard.sellers.update', $seller->id) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <input type="hidden" name="seller_id" value="{{ $seller->id }}" id="">
                        <!--begin::Aside column-->
                        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body text-center pt-0">
                                    ...
                                    <!--end::Hint-->
                                    <div class="mt-5">
                                        <h2> صورة {{$seller->name}}</h2>
                                        <div class="d-flex justify-content-center">
                                            <div class="image-input-wrapper image-input-placeholder w-125px h-125px">
                                                <img src="{{ $seller->assets['url'] }}" width="125px" height="125px" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card card-flush py-4 ">
                                ...
                                <div class="card-header border-0 ">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bold fs-3 mb-1"> تعديل بيانات {{ $seller->name }}</span>
                                    </h3>
                                </div>
                                <!--end::Header-->
                                <!--begin::Body-->
                                <div class="card-body py-3">
                                    <div class="mb-5">
                                        @include(
                                            ...
                                            ['name' => 'name', 'lable' => 'اسم البائع', 'placeholder' => 'أدخل اسم البائع', 'value' => $seller->name]
                                        )
                                    </div>
                                    <div class="mb-5">
                                        @include(
                                            'shared::layouts.forms.inputs.input-with-lable',
                                            ['name' => 'email', 'lable' => 'بريد البائع', 'placeholder' => 'أدخل بريد البائع', 'value' => $seller->email]
                                        )
                                    </div>
                                    <div class="mb-5">
                                        @include(
                                            'shared::layouts.forms.inputs.input-with-lable',
                                            ['name' => 'phone_number', 'id' => 'phone_number', 'lable' => 'رقم هاتف البائع', 'placeholder' => 'أدخل رقم هاتف البائع', 'value' => $seller->phone_number]
                                        )
                                        <!--begin::Hint-->
                                        <div class="text-muted">
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <div class="input-group mb-5">
                                            ...
                                            <input type="text" id="gold_coins" @class(['form-control', 'is-invalid' => $errors->has('gold_coins')])
                                                value="{{old('gold_coins', $seller->gold_coins)}}" name="gold_coins" />
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <select data-control="select2" name="status" @class([
                                            ...
                                            <option value="active" @selected(old('status', $seller->status) == 'active')>حساب
                                                فعال</option>
