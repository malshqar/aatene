                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 py-4">
                            <div class="card-body">
                                <!--begin::Form-->
                                <form class="form" action="{{ route('dashboard.blogs.store') }}" method="POST"
                                    ...
                                    <div class="fv-row mb-6 d-flex flex-center">
                                        ...
                                        <div class="w-75">
                                            @include('shared::layouts.forms.inputs.input-with-lable', ['name' => 'title', 'lable' => __("العنوان"), 'placeholder' => __("عنوان التدوينة")])
                                            <div class="mt-5">
                                                @include('shared::layouts.forms.inputs.input-with-lable', ['name' => 'writer', 'lable' => __("الكاتب"), 'placeholder' => __("كاتب التدوينة")])
                                            </div>
                                            <div class="mt-5">
