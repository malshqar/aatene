@extends('dashboard::index', ['title' => "تعديل بيانات {{ __($role->name) }}"])
@section('content')
    <!--begin::Main-->
    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
        ...
        <div class="d-flex flex-column flex-column-fluid">
            <!--begin::Toolbar-->
            @include('shared::layouts.components.elements.toolbar', ['back_url' => 'dashboard.roles.index', 'previews' => 'قائمة الأدوار', 'current' => ' تعديل بيانات '.  __($role->name)])
            <!--end::Toolbar-->
            <!--begin::Content-->
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 py-4">
                            ...
                            <div class="card-body">
                                <!--begin::Form-->
                                <form id="kt_modal_add_role_form" class="form" action="{{ route('dashboard.roles.update',$role->id) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                                    <!--begin::Scroll-->
                                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_role_scroll"
                                        ...
                                        <div class="fv-row mb-10">
                                            <div class="mb-5">
                                                @include('shared::layouts.forms.inputs.input-with-lable', ['name' => 'name', 'value'=>$role->name,'lable' => 'اسم الدور', 'placeholder' => 'أدخل اسم الدور'])
                                            </div>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                                    ...
                                                    <tbody class="text-gray-600 fw-semibold">
                                                        ...
                                                        <tr>
                                                            <td class="text-gray-800">تعيين
                                                                {{ __('super_admin') }} <span class="ms-2"
                                                                        ...
                                                                        <div class="d-flex">
                                                                            ...
                                                                            <label
                                                                                ...
                                                                                <input class="checkbox form-check-input"
                                                                                    ...
                                                                                    name="permission_ids[]" @if (in_array($permission->id,$rolePermissions)) checked @endif/>
