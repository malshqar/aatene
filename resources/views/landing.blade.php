...
<body id="kt_body" data-bs-spy="scroll" data-bs-target="#kt_landing_menu" class="bg-body position-relative app-blank">
            ...
            <div class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom landing-dark-bg"
                ...
                <div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9">
                    ...
                    <div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
                        ...
                        <!--begin::Action-->
                        <a href="{{asset('index.html')}}" class="btn btn-primary">Try Metronic</a>
                        <!--end::Action-->
                    </div>
                    <!--end::Heading-->
                    ...
                    <div class="d-flex flex-center flex-wrap position-relative px-5">
                        ...
                        <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="Aspnetzero">
                            <img src="{{asset('assets/media/svg/brand-logos/aspnetzero.svg')}}"
            ...
            <div class="pb-15 pt-18 landing-dark-bg">
                ...
                <div class="container">
                    ...
                    <div class="fs-2 fw-semibold text-muted text-center">
                        <a href="{{asset('account/security.html')}}" class="link-primary fs-4 fw-bold">Marcus
                            Levy,</a>
                ...
                <div class="tns tns-default" style="direction: ltr">
                    ...
                    <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000"
                        ...
                        <div class="text-center">
                            <!--begin::Photo-->
                            <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                style="background-image:url('{{asset('assets/media/avatars/300-2.jpg')}}')">
                            </div>
                            <!--end::Photo-->
                        ...
                        <div class="text-center">
                            <!--begin::Photo-->
                            <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                style="background-image:url('{{asset('assets/media/avatars/300-5.jpg')}}')">
                            </div>
                            <!--end::Photo-->
                        ...
                        <div class="text-center">
                            <!--begin::Photo-->
                            <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                style="background-image:url('{{asset('assets/media/avatars/300-20.jpg')}}')">
                            </div>
                            <!--end::Photo-->
                        ...
                        <div class="text-center">
                            <!--begin::Photo-->
                            <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                style="background-image:url('{{asset('assets/media/avatars/300-23.jpg')}}')">
                            </div>
                            <!--end::Photo-->
                        ...
                        <div class="text-center">
                            <!--begin::Photo-->
                            <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                style="background-image:url('{{asset('assets/media/avatars/300-12.jpg')}}')">
                            </div>
                            <!--end::Photo-->
                        ...
                        <div class="text-center">
                            <!--begin::Photo-->
                            <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                style="background-image:url('{{asset('assets/media/avatars/300-9.jpg')}}')">
                            </div>
                            <!--end::Photo-->
                        ...
                        <div class="col-lg-6 pe-lg-16 mb-10 mb-lg-0">
                            ...
                            <div class="rounded landing-dark-border p-9">
                                ...
                                <span class="fw-normal fs-4 text-gray-700">
                                    ...
                                    <a href="{{asset('pages/user-profile/overview.html')}}"
    ...
    <div class="app-engage " id="kt_app_engage">
        ...
        <!--begin::Prebuilts toggle-->
        <a href="https://1.envato.market/Vm7VRE" target="_blank" class="app-engage-btn hover-success">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo1/index.html"
                                                    ...
                                                    <span
                                                        ...
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo1.png')}}"
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo2/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo2.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo39/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo39.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo31/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo31.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo9/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo9.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo38/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo38.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo30/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo30.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo6/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo6.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo60/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo60.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo8/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo8.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo62/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo62.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo58/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo58.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo56/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo56.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo34/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo34.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo27/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo27.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo29/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo29.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo57/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo57.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo3/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo3.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo36/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo36.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo20/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo20.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo59/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo59.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo55/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo55.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo51/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo51.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo10/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo10.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo61/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo61.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo52/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo52.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo63/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo63.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo40/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo40.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo23/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo23.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo64/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo64.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo35/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo35.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo33/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo33.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo19/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo19.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo25/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo25.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo50/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo50.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo32/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo32.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo37/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo37.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo42/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo42.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo5/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo5.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo16/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo16.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo4/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo4.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo53/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo53.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo7/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo7.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo21/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo21.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo24/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo24.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo28/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo28.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo44/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo44.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo11/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo11.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo26/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo26.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo22/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo22.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo41/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo41.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo18/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo18.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo54/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo54.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo15/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo15.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo14/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo14.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo13/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo13.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo12/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo12.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo48/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo48.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo17/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo17.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo49/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo49.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo43/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo43.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo45/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo45.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo47/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo47.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo46/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/demos/demo46.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                    ...
                                    <div class="hover-scroll-y pe-12 me-n12" data-kt-scroll="true"
                                        ...
                                        <div class="row gy-10">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('index.html')}}" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/dashboards/multipurpose-demo1.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('dashboards/marketing.html')}}" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/dashboards/marketing.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('dashboards/social.html')}}" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/dashboards/social.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('dashboards/ecommerce.html')}}" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/dashboards/ecommerce.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('dashboards/store-analytics.html')}}"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/dashboards/store-analytics.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('dashboards/logistics.html')}}" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/dashboards/logistics.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('dashboards/delivery.html')}}" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/dashboards/delivery.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('dashboards/online-courses.html')}}"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/dashboards/online-courses.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('dashboards/school.html')}}" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/dashboards/school.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('dashboards/crypto.html')}}" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/dashboards/crypto.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('dashboards/finance-performance.html')}}"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/dashboards/finance-performance.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('dashboards/website-analytics.html')}}"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/dashboards/website-analytics.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('dashboards/bidding.html')}}" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/dashboards/bidding.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('dashboards/podcast.html')}}" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/dashboards/podcast.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('dashboards/projects.html')}}" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/dashboards/projects.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('dashboards/call-center.html')}}" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/dashboards/call-center.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('dashboards/pos.html')}}" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/dashboards/pos.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                    ...
                                    <div class="hover-scroll-y pe-12 me-n12" data-kt-scroll="true"
                                        ...
                                        <div class="row gy-10">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('apps/projects/list.html')}}" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/apps/projects.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('apps/ecommerce/catalog/products.html')}}"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/apps/ecommerce.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('apps/customers/list.html')}}" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/apps/customers.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('apps/subscriptions/list.html')}}" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/apps/subscriptions.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('apps/user-management/users/list.html')}}"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/apps/user-management.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('apps/invoices/create.html')}}" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/apps/invoices.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('apps/support-center/overview.html')}}"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/apps/support-center.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('apps/chat/private.html')}}" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/apps/chat.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('apps/calendar.html')}}" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/apps/calendar.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('apps/file-manager/folders.html')}}"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/apps/file-manager.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('apps/inbox/listing.html')}}" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/apps/inbox.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="{{asset('apps/contacts/getting-started.html')}}"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                            data-src="{{asset('assets/media/preview/prebuilts/apps/contacts.png')}}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="tab-pane fade show active"
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('authentication/layouts/corporate/sign-in.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/auth-corporate.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('authentication/layouts/creative/sign-in.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/auth-creative.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('authentication/layouts/fancy/sign-in.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/auth-fancy.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('authentication/layouts/overlay/sign-in.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/auth-overlay.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('authentication/extended/multi-steps-sign-up.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/auth-multistep.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('authentication/layouts/corporate/two-factor.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/auth-2factor.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('authentication/general/password-confirmation.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/auth-passwordchanged.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('authentication/general/verify-email.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/auth-verifyemail.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('authentication/general/welcome.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/auth-welcome.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('authentication/general/coming-soon.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/auth-comingsoon.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('authentication/general/account-deactivated.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/auth-accountdeactivated.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('authentication/general/error-404.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/auth-404.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('authentication/general/error-500.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/auth-500.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="show"
                                                        ...
                                                        <div class="row g-10 pt-2 pb-5">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="{{asset('pages/user-profile/overview.html')}}"
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                            data-src="{{asset('assets/media/preview/prebuilts/pages/profile-overview.png')}}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="{{asset('pages/user-profile/projects.html')}}"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="{{asset('pages/user-profile/campaigns.html')}}"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                            data-src="{{asset('assets/media/preview/prebuilts/pages/profile-campaigns.png')}}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="{{asset('pages/user-profile/documents.html')}}"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                            data-src="{{asset('assets/media/preview/prebuilts/pages/profile-documents.png')}}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="{{asset('pages/user-profile/followers.html')}}"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                            data-src="{{asset('assets/media/preview/prebuilts/pages/profile-followers.png')}}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="{{asset('pages/user-profile/activity.html')}}"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                            data-src="{{asset('assets/media/preview/prebuilts/pages/profile-activity.png')}}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                    ...
                                                    <div class="collapse"
                                                        ...
                                                        <div class="row g-10 pt-2 pb-5">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="{{asset('pages/about.html')}}"
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                            data-src="{{asset('assets/media/preview/prebuilts/pages/corporate-aboutus.png')}}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="{{asset('pages/contact.html')}}"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                            data-src="{{asset('assets/media/preview/prebuilts/pages/corporate-contactus.png')}}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="{{asset('pages/licenses.html')}}"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                            data-src="{{asset('assets/media/preview/prebuilts/pages/corporate-license.png')}}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="{{asset('pages/team.html')}}"
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                            data-src="{{asset('assets/media/preview/prebuilts/pages/corporate-ourteam.png')}}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="{{asset('pages/sitemap.html')}}"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                            data-src="{{asset('assets/media/preview/prebuilts/pages/corporate-sitemap.png')}}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                    ...
                                                    <div class="collapse"
                                                        ...
                                                        <div class="row g-10 pt-2 pb-5">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="{{asset('pages/social/feeds.html')}}"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                            data-src="{{asset('assets/media/preview/prebuilts/pages/social-activity.png')}}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="{{asset('pages/social/activity.html')}}"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                            data-src="{{asset('assets/media/preview/prebuilts/pages/social-feeds.png')}}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="{{asset('pages/social/followers.html')}}"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                            data-src="{{asset('assets/media/preview/prebuilts/pages/social-followers.png')}}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="{{asset('pages/social/settings.html')}}"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                            data-src="{{asset('assets/media/preview/prebuilts/pages/social-settings.png')}}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                    ...
                                                    <div class="collapse"
                                                        ...
                                                        <div class="row g-10 pt-2 pb-5">
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="{{asset('pages/faq/classic.html')}}"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                            data-src="{{asset('assets/media/preview/prebuilts/pages/faq-classic.png')}}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="{{asset('pages/faq/extended.html')}}"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                            data-src="{{asset('assets/media/preview/prebuilts/pages/faq-extended.png')}}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="{{asset('pages/blog/home.html')}}"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                            data-src="{{asset('assets/media/preview/prebuilts/pages/blog-home.png')}}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <!--begin::Preview-->
                                                                <a href="{{asset('pages/blog/post.html')}}"
                                                                    data-kt-href="true"
                                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                    <!--begin::Title-->
                                                                    <h3
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                            data-src="{{asset('assets/media/preview/prebuilts/pages/blog-post.png')}}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                            ...
                                            <div class="tab-pane fade " id="kt_app_engage_prebuilts_tab_pages_account"
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('account/overview.html')}}" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/account-overview.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('account/settings.html')}}" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/account-settings.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('account/billing.html')}}" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/account-billing.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('account/security.html')}}" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/account-security.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('account/referrals.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/account-referrals.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('account/logs.html')}}" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/account-logs.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('account/api-keys.html')}}" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/account-apikeys.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('account/statements.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/account-statements.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                            ...
                                            <div class="tab-pane fade " id="kt_app_engage_prebuilts_tab_pages_modals"
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('utilities/modals/general/view-users.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/modal-viewfriends.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('utilities/modals/general/upgrade-plan.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/modal-upgradeplan.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('utilities/modals/wizards/top-up-wallet.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/modal-topupwallet.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('utilities/modals/general/share-earn.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/modal-shareandearn.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('utilities/modals/general/select-users.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/modal-selectuser.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('utilities/modals/forms/bidding.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/modal-placeyourbid.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('utilities/modals/wizards/offer-a-deal.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/modal-offeradeal.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('utilities/modals/forms/new-target.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/modal-newtarget.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('utilities/modals/forms/new-card.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/modal-newcard.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('utilities/modals/forms/new-address.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/modal-newaddress.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('utilities/modals/general/invite-friends.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/modal-invitefriend.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('utilities/modals/wizards/create-project.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/modal-createproject.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('utilities/modals/wizards/create-campaign.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/modal-createcampaign.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('utilities/modals/wizards/create-account.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/modal-createbusinessacc.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('utilities/modals/wizards/create-app.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/modal-createapp.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('utilities/modals/forms/create-api-key.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/modal-createapikey.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('utilities/modals/wizards/two-factor-authentication.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/modal-2factorauth.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                            ...
                                            <div class="tab-pane fade " id="kt_app_engage_prebuilts_tab_pages_wizards"
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('utilities/wizards/horizontal.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/wizard-2factorauth.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="{{asset('utilities/wizards/horizontal.html')}}"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/wizard-horizontal.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('utilities/wizards/vertical.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/wizard-vertical.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                            ...
                                            <div class="tab-pane fade " id="kt_app_engage_prebuilts_tab_pages_search"
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('utilities/search/users.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/search-users.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('utilities/search/horizontal.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/search-horizontal.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('utilities/search/vertical.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/search-vertical.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('utilities/search/select-location.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/search-location.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                            ...
                                            <div class="tab-pane fade " id="kt_app_engage_prebuilts_tab_pages_widgets"
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('widgets/charts.html')}}" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/widgets-charts.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('widgets/feeds.html')}}" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/widgets-feeds.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('widgets/lists.html')}}" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/widgets-lists.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('widgets/mixed.html')}}" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/widgets-mixed.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('widgets/statistics.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/widgets-stats.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('widgets/tables.html')}}" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/widgets-tables.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                            ...
                                            <div class="tab-pane fade "
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('authentication/email/welcome-message.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/email-welcome.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('authentication/email/subscription-confirmed.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/email-subscriptionconfirmed.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('authentication/email/reset-password.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/email-resetpassword.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('authentication/email/card-declined.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/email-creditcarddeclined.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('authentication/email/promo-1.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/email-promo1.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('authentication/email/promo-2.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/email-promo2.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="{{asset('authentication/email/promo-3.html')}}"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{asset('assets/media/preview/demos/placeholder.jpg')}}"
                                                                    data-src="{{asset('assets/media/preview/prebuilts/pages/email-promo3.png')}}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="{{asset('index.html')}}">
                                                    Multipurpose </a>
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('dashboards/marketing.html')}}">
                                                    Marketing Dashboard </a>




                                                <a class="fw-6 fw-semibold" href="{{asset('dashboards/social.html')}}">
                                                    Social Dashboard </a>
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('dashboards/ecommerce.html')}}">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('dashboards/store-analytics.html')}}">
                                                    Store Analytics </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('dashboards/logistics.html')}}">
                                                    Logistics </a>
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('dashboards/delivery.html')}}">
                                                    Delivery </a>
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('dashboards/online-courses.html')}}">
                                                    Online Courses </a>




                                                <a class="fw-6 fw-semibold" href="{{asset('dashboards/school.html')}}">
                                                    Hello Tyler </a>




                                                <a class="fw-6 fw-semibold" href="{{asset('dashboards/crypto.html')}}">
                                                    My Balance: 37,045$ </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('dashboards/finance-performance.html')}}">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('dashboards/website-analytics.html')}}">
                                                    Website Analytics </a>




                                                <a class="fw-6 fw-semibold" href="{{asset('dashboards/bidding.html')}}">
                                                    Bidding Dashboard </a>




                                                <a class="fw-6 fw-semibold" href="{{asset('dashboards/podcast.html')}}">
                                                    Podcast Dashboard </a>
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('dashboards/projects.html')}}">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('dashboards/call-center.html')}}">
                                                    Call Center </a>




                                                <a class="fw-6 fw-semibold" href="{{asset('dashboards/pos.html')}}">
                                                    POS System </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('authentication/layouts/corporate/sign-in.html')}}">
                                                    Corporate </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('authentication/layouts/creative/sign-in.html')}}">
                                                    Creative </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('authentication/layouts/fancy/sign-in.html')}}">
                                                    Fancy </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('authentication/layouts/overlay/sign-in.html')}}">
                                                    Overlay </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('authentication/extended/multi-steps-sign-up.html')}}">
                                                    Multi-Step </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('authentication/layouts/corporate/two-factor.html')}}">
                                                    Two-Factor </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('authentication/general/password-confirmation.html')}}">
                                                    Password Changed </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('authentication/general/verify-email.html')}}">
                                                    Verify Email </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('authentication/general/welcome.html')}}">
                                                    Welcome </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('authentication/general/coming-soon.html')}}">
                                                    Coming Soon </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('authentication/general/account-deactivated.html')}}">
                                                    Account Deactivated </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('authentication/general/error-404.html')}}">
                                                    404 Page </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('authentication/general/error-500.html')}}">
                                                    505 Page </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="{{asset('account/overview.html')}}">
                                                    Overview </a>



                                                <a class="fw-6 fw-semibold" href="{{asset('account/settings.html')}}">
                                                    Settings </a>



                                                <a class="fw-6 fw-semibold" href="{{asset('account/billing.html')}}">
                                                    Billing </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="{{asset('account/security.html')}}">
                                                    Security </a>



                                                <a class="fw-6 fw-semibold" href="{{asset('account/referrals.html')}}">
                                                    Referrals </a>



                                                <a class="fw-6 fw-semibold" href="{{asset('account/logs.html')}}">
                                                    Logs </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="{{asset('account/api-keys.html')}}">
                                                    API Keys </a>



                                                <a class="fw-6 fw-semibold" href="{{asset('account/statements.html')}}">
                                                    Statements </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('utilities/modals/general/view-users.html')}}">
                                                    View Friends </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('utilities/modals/general/upgrade-plan.html')}}">
                                                    Upgrade Plan </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('utilities/modals/wizards/top-up-wallet.html')}}">
                                                    Topup Wallet </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('utilities/modals/general/share-earn.html')}}">
                                                    Share & Earn </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('utilities/modals/general/select-users.html')}}">
                                                    Select User </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('utilities/modals/forms/bidding.html')}}">
                                                    Place Bid </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('utilities/modals/wizards/offer-a-deal.html')}}">
                                                    Offer Deal </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('utilities/modals/forms/new-target.html')}}">
                                                    New Target </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('utilities/modals/forms/new-card.html')}}">
                                                    New Card </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('utilities/modals/forms/new-address.html')}}">
                                                    New Address </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('utilities/modals/general/invite-friends.html')}}">
                                                    Invite Friend </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('utilities/modals/wizards/create-project.html')}}">
                                                    Create Project </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('utilities/modals/wizards/create-campaign.html')}}">
                                                    Create Campaign </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('utilities/modals/wizards/create-account.html')}}">
                                                    Create Business Account </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('utilities/modals/wizards/create-app.html')}}">
                                                    Create App </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('utilities/modals/forms/create-api-key.html')}}">
                                                    Create Api Key </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('utilities/modals/wizards/two-factor-authentication.html')}}">
                                                    2 Factor Auth </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('utilities/wizards/horizontal.html')}}">
                                                    2 Factor Auth </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('utilities/wizards/vertical.html')}}">
                                                    Vertical </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('utilities/search/users.html')}}">
                                                    Search Users </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('utilities/search/horizontal.html')}}">
                                                    Search Horizontal </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('utilities/search/vertical.html')}}">
                                                    Search Vertical </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('utilities/search/select-location.html')}}">
                                                    Search Location </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="{{asset('widgets/charts.html')}}">
                                                    Charts </a>



                                                <a class="fw-6 fw-semibold" href="{{asset('widgets/feeds.html')}}">
                                                    Feeds </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="{{asset('widgets/lists.html')}}">
                                                    Lists </a>



                                                <a class="fw-6 fw-semibold" href="{{asset('widgets/mixed.html')}}">
                                                    Mixed </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="{{asset('widgets/statistics.html')}}">
                                                    Statistics </a>



                                                <a class="fw-6 fw-semibold" href="{{asset('widgets/tables.html')}}">
                                                    Tables </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('authentication/email/welcome-message.html')}}">
                                                    Welcome </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('authentication/email/subscription-confirmed.html')}}">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('authentication/email/reset-password.html')}}">
                                                    Reset Password </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('authentication/email/card-declined.html')}}">
                                                    Card Declined </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('authentication/email/promo-1.html')}}">
                                                    Promotion 1 </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('authentication/email/promo-2.html')}}">
                                                    Promotion 2 </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('authentication/email/promo-3.html')}}">
                                                    Promotion 3 </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('pages/user-profile/overview.html')}}">
                                                    Profile Overview </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('pages/user-profile/projects.html')}}">
                                                    User Projects </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('pages/user-profile/campaigns.html')}}">
                                                    User Campaigns </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('pages/user-profile/documents.html')}}">
                                                    User Documents </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('pages/user-profile/followers.html')}}">
                                                    User Followers </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('pages/user-profile/activity.html')}}">
                                                    User Activity </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="{{asset('pages/about.html')}}">
                                                    About Us </a>



                                                <a class="fw-6 fw-semibold" href="{{asset('pages/contact.html')}}">
                                                    Contact Us </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="{{asset('pages/licenses.html')}}">
                                                    License </a>



                                                <a class="fw-6 fw-semibold" href="{{asset('pages/team.html')}}">
                                                    Our Team </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="{{asset('pages/sitemap.html')}}">
                                                    Sitemap </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="{{asset('pages/social/feeds.html')}}">
                                                    Activity </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('pages/social/activity.html')}}">
                                                    Feeds </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('pages/social/followers.html')}}">
                                                    Followers </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('pages/social/settings.html')}}">
                                                    Settings </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="{{asset('pages/faq/classic.html')}}">
                                                    FAQ Classic </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="{{asset('pages/faq/extended.html')}}">
                                                    FAQ Extended </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="{{asset('pages/blog/home.html')}}">
                                                    Blog Home </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="{{asset('pages/blog/post.html')}}">
                                                    Blog Post </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="{{asset('apps/projects/list.html')}}">
                                                    Projects </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('apps/ecommerce/catalog/products.html')}}">
                                                    Ecommerce </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('apps/customers/list.html')}}">
                                                    Customers </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('apps/subscriptions/list.html')}}">
                                                    Subscriptions </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('apps/user-management/users/list.html')}}">
                                                    User Management </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('apps/invoices/create.html')}}">
                                                    Invoices </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('apps/support-center/overview.html')}}">
                                                    Support Center </a>



                                                <a class="fw-6 fw-semibold" href="{{asset('apps/chat/private.html')}}">
                                                    Chat </a>



                                                <a class="fw-6 fw-semibold" href="{{asset('apps/calendar.html')}}">
                                                    Calendar </a>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('apps/file-manager/folders.html')}}">
                                                    File Manager </a>



                                                <a class="fw-6 fw-semibold" href="{{asset('apps/inbox/listing.html')}}">
                                                    Inbox </a>



                                                <a class="fw-6 fw-semibold"
                                                    href="{{asset('apps/contacts/getting-started.html')}}">
                                                    Contacts </a>
